    ...
    bodies: [
      {
        ...
        radius: 0.45,
        color: '#f43f5e',
        position: createVec(-4.85, 0.0, 0.0),
        velocity: createVec(0.466 * 1.5, 0.432 * 1.5, 0.0),
        trail: [],
      },
      {
        id: 'b2',
      ...
      },
      {
        ...
        velocity: createVec(-2 * 0.466 * 1.5, -2 * 0.432 * 1.5, 0.0),
        trail: [],
      },
    ],
  },
    ...
    bodies: [
      {
        ...
        color: '#f59e0b',
        emissive: true,
        position: createVec(0, 0, 0),
        velocity: createVec(0, 0, 0),
        trail: [],
      },
      {
        id: 'jupiter',
        ...
        radius: 0.5,
        color: '#ec4899',
        position: createVec(12, 0, 0),
        velocity: createVec(0, Math.sqrt((1.0 * 800) / 12), 0),
        trail: [],
      },
      {
        id: 'trojan',
        ...
        radius: 0.2,
        color: '#22d3ee',
        position: createVec(12 * Math.cos(Math.PI / 3), 12 * Math.sin(Math.PI / 3), 0),
        velocity: createVec(
          -Math.sqrt((1.0 * 800) / 12) * Math.sin(Math.PI / 3),
          Math.sqrt((1.0 * 800) / 12) * Math.cos(Math.PI / 3),
          0
        ),
        trail: [],
      },
